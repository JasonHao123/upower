...
<div data-role="navbar">
	<ul>
		<li><a data-ajax="false" href="<c:url value="/personal/index.do" />" <c:if test="${navi=='' || navi=='job' }">class="ui-btn-active"</c:if> >个人消息</a></li>
		<li><a data-ajax="false" href="<c:url value="/company/index.do" />" <c:if test="${navi=='company' }">class="ui-btn-active"</c:if> >群消息</a></li>
