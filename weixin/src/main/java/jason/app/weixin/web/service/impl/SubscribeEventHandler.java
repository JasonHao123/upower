...
public class SubscribeEventHandler extends EventHandler {
	...
	public WeixinParam handle(WeixinParam params, WeixinHeader header) {
        ...
        response.setContent("欢迎使用友势力社交平台！我们的平台非常认可社交网络和个人信用的价值，本平台通过对您的社交网络和个人信用进行评价，提供差异化的服务。"+" <a href=\"http://www.weaktie.cn/weixin/social/conversation.do?id=14\">意见与建议</a>");
        return response;
	}
